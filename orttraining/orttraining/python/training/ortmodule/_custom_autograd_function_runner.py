...
def _get_context(forward_tensor_outputs: List[torch.Tensor]) -> Tuple[any, Optional[torch.Tensor]]:
    ...
    Notes:
        1. All forward outputs of torch.autograd.Function shared the same gradient function pointer,
        ...
        2. Context can be None because not all autograd.Function's are differentiable. The function
